...
const descriptionText = unfundedCount === 0
    ? "All of our games are fully funded! Thank you for your support."
    : `A total of ${unfundedCount} ${unfundedCount === 1 ? "game remains" : "games remain"} unfunded. Help us fund these great projects!`;
...
firstGameElement.innerText = firstGame ? firstGame.name : "No games available";
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
const secondGameElement = document.createElement("p");
secondGameElement.innerText = secondGame ? secondGame.name : "No runner up available";
